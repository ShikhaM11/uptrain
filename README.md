...
**[UpTrain](https://uptrain.ai)** is a Python framework that ensures your Gen AI applications are performing reliably by allowing users  to check them on aspects such as correctness, structural integrity, bias, hallucination, etc. UpTrain can be used to:
